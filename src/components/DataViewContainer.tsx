import DataViewConfig from "../models/DataViewConfig.ts";
import NoDataMessage from "./NoDataMessage.tsx";

export default function DataViewContainer(props:DataViewConfig) {
        ...
        <>
            <section
                ...
                {props.dataArray.length === 0 ? (
                    <NoDataMessage message={props.noDataMessage} />
