...
import AddVehicleModalComponent from "../components/vehicleComponents/AddVehicleModal.tsx";
    ...
    return (
        <>
            ...
            <div className="flex justify-center items-center space-x-20 mb-6">
                ...
                <AddButton label="Add Vehicle" onClick={openVehicleModal}/>
            </div>
            ...
            {isViewModalOpen && selectedVehicle && (
                <div
                    ...
                    aria-hidden="true"
                >
                    <div className="bg-amber-50 overflow-y-scroll rounded-lg shadow-2xl max-w-lg w-full mx-4 sm:mx-6 my-6 relative max-h-[500px]">
                        {/* Modal Header */}
